...
public class HashTable {
	...
	private void rehash() {
		...
		for (Hashable c : hashArray) {// gose trow eatch elament in the ople hash table add add it to the new one
			// whith a new hash
			if (c != null) {
				...
				LinkedListNode<Integer> temp = c.getList().head;// adjusts the hash list of characters or books that the
				// rehashed list is in
