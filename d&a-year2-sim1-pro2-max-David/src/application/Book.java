...
public class Book implements Hashable {
	private LinkedList<Integer> characters = new LinkedList<Integer>(); // All books will have their own list of
	// associated characters/Or hash keys if change
	// is needed.
	...
	public Book(String title, String author, String publisher, int pubYear, int numOfPages, String genre, String plot,
			int sort) {
		this.title = title;
		this.author = author;
